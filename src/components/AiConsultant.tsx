...
const AiConsultant: React.FC<AiConsultantProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="w-full h-full bg-white/95 dark:bg-[#0F0F11]/95 backdrop-blur-xl rounded-2xl flex flex-col relative overflow-hidden font-sans border border-white/20 dark:border-white/5 transition-all duration-300">
